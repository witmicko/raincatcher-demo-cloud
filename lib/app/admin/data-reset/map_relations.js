 ...
 * @param {String} type - type of the item e.g. results, workflow
 * @param {Object} dataItem - single item object e.g workorder, memberships
 ...
 * @param  {Object} dataItem - single memberships item object
 * @param {Array} mappings - an array of mappings objects for groups
 * @returns {Object} dataItem - memberships dataItem object with groups property updated with newId of relevant mapping
 */
