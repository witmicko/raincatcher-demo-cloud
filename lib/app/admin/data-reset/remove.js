...
function removeData(mediator) {
  ...
  // Process all synchronously, return empty value at the end as we ignore the results
 ...
 * @param {Object} mediator - mediator object used for communication
 * @param {String} itemType - type of the item to remove e.g. results, workorder
